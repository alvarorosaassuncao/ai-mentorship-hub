  ...
  return (
    <section className="py-20 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-1/4 right-10 w-96 h-96 bg-primary/10 rounded-full blur-3xl animate-glow-pulse" style={{ animationDelay: '1s' }}></div>
      </div>
      ...
      <div className="container mx-auto px-4 relative">
        <div className="max-w-7xl mx-auto">
          ...
          {/* Plans Grid */}
          <div className="grid lg:grid-cols-2 gap-8 max-w-5xl mx-auto animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
                  ...
                  <div className="relative p-8 space-y-6">
                    ...
                    <Button
                      ...
                      className={`w-full group/btn transition-all duration-300 ${
                        plan.highlight
                          ? 'bg-gradient-secondary hover:shadow-glow text-secondary-foreground'
                          : 'bg-gradient-primary hover:shadow-card text-primary-foreground'
                      }`}
                    >
                      Saiba mais
