  ...
  return <section className="py-20 relative">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6 animate-fade-in-up" style={{
          animationDelay: '0.2s'
        }}>
            {buttons.map((btn, index) => {
            const Icon = btn.icon;
            return <Button key={index} onClick={() => openWhatsApp(btn.message)} className={`group relative h-auto py-8 px-6 bg-gradient-to-br ${btn.gradient} hover:shadow-glow transition-all duration-300 hover:scale-105`} style={{
